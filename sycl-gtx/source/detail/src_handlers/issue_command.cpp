#include "detail/src_handlers/issue_command.h"
...
// TODO
void issue_command::compile_command(
...
void issue_command::enqueue_task(shared_ptr_class<kernel> kern, event* evnt) {
  command::group_::add_kernel_enqueue_task(
    enqueue_task_command, __func__, kern, evnt);
}
