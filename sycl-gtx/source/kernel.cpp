...
cl_event kernel::get_cl_event(event* evnt) { return evnt->evnt.get(); }
cl_command_queue kernel::get_cl_queue(queue* q) { return q->get(); }
...
program kernel::get_program() const { return *prog; }

void kernel::set(cl_kernel openclKernelObject) { kern = openclKernelObject; }
