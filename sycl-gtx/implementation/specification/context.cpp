...
context::context()
	: context(nullptr, detail::default_async_handler, false) {}
...
context::context(const device_selector& deviceSelector, info::gl_context_interop interopFlag, const async_handler& asyncHandler)
	: context(nullptr, asyncHandler, interopFlag, {}, nullptr, deviceSelector) {}

context::context(const device& dev, info::gl_context_interop interopFlag, const async_handler& asyncHandler)
	: context(nullptr, asyncHandler, interopFlag, {dev}) {}

context::context(const platform& plt, info::gl_context_interop interopFlag, const async_handler& asyncHandler)
	: context(nullptr, asyncHandler, interopFlag, {}, &plt) {}

context::context(vector_class<device> deviceList, info::gl_context_interop interopFlag, const async_handler& asyncHandler)
