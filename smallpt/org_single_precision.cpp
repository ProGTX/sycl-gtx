...
void compute_org_sp(int w, int h, int samps, Ray &cam, Vec &cx, Vec &cy, Vec r, Vec *c) {
	for(int y = 0; y < h; y++) { // Loop over image rows
		org_sp::compute_inner(y, w, h, samps, cam, cx, cy, r, c);
	}
}
void compute_org_sp_openmp(int w, int h, int samps, Ray &cam, Vec &cx, Vec &cy, Vec r, Vec *c) {
